...
useEffect(() => {
  if (amount !== null) {
    initializePaymentSheet(); // Initialize once amount is set
  }
}, [amount]);
    ...
    <View style={{ flex: 1, backgroundColor: "#fff" }}>
            ...
            <TouchableOpacity key={listing.id} onPress={() => openViewModal(listing)}>
              <View style={styles.listingCard}>
                ...
                <TouchableOpacity
                    ...
                    onPress={async () => {
                      setAmount(listing.price_per_hour); // Dynamically set the amount
                      await handlePayment(); // Call handlePayment after amount is set and sheet is initialized
                    }}
                    disabled={ploading} 
                  >
      ...
      >
            ...
            <TouchableOpacity style={styles.optionButton}>
              <Text style={styles.optionButtonText}>Cash Payment</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.optionButton}>
              <Text style={styles.optionButtonText}>Online Payment</Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity style={styles.cancelButton} onPress={() => setBuyModalVisible(false)}>
      ...
      <>
        ...
        <ScrollView showsVerticalScrollIndicator={false} className="mt-12">
          ...
          <View style={styles.buttonContainer}>
            <TouchableOpacity style={styles.iconButton} onPress={() => handleSMS(selectedListing.owner1?.phone)}>
			<MaterialCommunityIcons name="email-outline" size={24} color="black" />
              <Text style={styles.iconButtonText}>SMS</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.iconButton} onPress={() => handleCall(selectedListing.owner1?.phone)}>
